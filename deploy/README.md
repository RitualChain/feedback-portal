# RitualChain Deployment

This directory contains deployment configurations for RitualChain.
...
| **[Cloud](./cloud/README.md)**             | RitualChain team only          | Cloudflare Workers   |
...
## RitualChain Cloud (Internal)

The `cloud/` directory contains Cloudflare Workers deployment configuration for RitualChain Cloud (app.ritual.net).

> **Note**: This is used internally by the RitualChain team. Self-hosted users should ignore this directory.
...
deploy/
├── README.md              # This file
├── cloud/                 # RitualChain Cloud (Cloudflare Workers)
...
RitualChain supports different build configurations:
...
Enterprise features include SSO/SAML, SCIM, and Audit Logs. Contact sales@ritual.net for licensing.
