...
<head>
  ...
  <meta name="description" content="RitualChain API Documentation - Build powerful integrations" />
  <title>API Reference | RitualChain</title>
...
<body>
  <header class="header">
    <div class="header-inner">
      <a href="/" class="logo">
        <img src="/logo.png" alt="RitualChain" />
        <span>RitualChain</span>
  ...
  <section class="hero">
    <div class="hero-inner">
      ...
      <h1>API Reference</h1>
      <p>Build integrations and automate workflows with the RitualChain API</p>
      <div class="hero-meta">
