 ...
 *
 *   Inbound:  External platform → RitualChain
 ...
 *     plan changes; RitualChain updates user.metadata and re-evaluates segments.
 *
 *   Outbound: RitualChain → External platform
...
export interface UserIdentifyPayload {
  /** Email — primary lookup key for matching RitualChain users. */
  email: string
