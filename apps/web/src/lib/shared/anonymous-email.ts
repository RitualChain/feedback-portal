 ...
 * placeholder ("temp-<id>@anon.ritual.net"). That address is never real — it
 ...
 *
 * ANON_EMAIL_DOMAIN / isSyntheticAnonEmail are owned by @ritualchain/email (the
 ...
 */
import { ANON_EMAIL_DOMAIN, isSyntheticAnonEmail } from '@ritualchain/email/anon'
